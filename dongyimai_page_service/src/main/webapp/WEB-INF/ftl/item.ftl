                        ...
                        <#list specList as spec>
                            <dl>
                                ...
                                <#list spec.attributeValue as option>
                                    <dd><a href="javascript:;" class="{{isSelect('${spec.attributeName}','${option}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${option}')">${option}<span title="点击取消选择">&nbsp;</span>
                                        </a></dd>
                                </#list>
